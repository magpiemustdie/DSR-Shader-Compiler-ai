// FRPG_Water_Reflect_GBuffer.fx — Water reflection GBuffer (PntSS/PntSSSS) path
// Reconstructed from FRPG_Water_Reflect____PntSS.fpo via 3DMigoto HLSL
// Uses DL_FREG cbuffer layout (cb0[196])
// Key difference from Env: uses t0 (Texture2D, reflection RT) instead of t12 (TextureCube) for env
...
) : SV_Target0
{
    ...
    // Reflection lookup from t0 (2D render target, UV = normal.xz * DL_FREG_124 + screenUV)
    r11.xy = r1.xz * DL_FREG_124 + r0.yz;
    r11.xyz = t0.Sample(s0, r11.xy).xyz;
