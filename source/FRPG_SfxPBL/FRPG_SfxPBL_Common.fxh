// FRPG_SfxPBL_Common.fxh — PS common header for FRPG_SfxPBL family
// Reconstructed from DSR DXBC (FRPG_SfxPBL_DX11.shaderbnd.dcx)
// cb0 layout matches reference _Globals, cb1 = AlphaTestBuffer
//
// Guards:
//   SFXPBL_NO_GLOBALS     — no cb0 registers at all (BlurType0: no cbuffer in ref)
//   SFXPBL_NO_SCREENSIZE  — c32 absent (Tracer: ref has no gFC_ScreenSize)
//   SFXPBL_NO_REG67       — c6/c7 absent (only SimpleSprite/PointSprite have DL_FREG_6/7)
//   SFXPBL_HAS_ALPHATEST  — declare AlphaTestBuffer (b1) + helper
...
float4 g_fog_color          : register(c4);   // SimpleSprite/PointSprite: DL_FREG_004
...
// ---- Textures / samplers ----
Texture2D    gSMP_0 : register(t0);         // DiffuseSampler
