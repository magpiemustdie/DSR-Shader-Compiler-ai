// FRPG_Compute_SSAO_BlurUpsamplePreMinBlendOut.fx
// Reconstructed from DSR DXBC cs_5_0 (08/17). MiniEngine AoBlurAndUpsampleCS.hlsli,
// COMBINE_LOWER_RESOLUTIONS + BLEND_WITH_HIGHER_RESOLUTION variants:
// AO1 = min(LoResAO1, LoResAO2); result = HiAO * WeightedSum / TotalWeight (t4).
// Ref gather order in Phase D: t4, t0, t1.
// Textures: t0 = LoResDB, t1 = HiResDB, t2 = LoResAO1, t3 = LoResAO2, t4 = HiResAO;
//           u0 = AoResult; s0.
...
{
    float4 AO1 = min(LoResAO1.Gather(LinearSampler, uv), LoResAO2.Gather(LinearSampler, uv));
